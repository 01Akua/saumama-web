...
const es = {
  ...
  blogPage: {
    ...
    versionNote: "Versión alternativa en formato blog — compárala con la versión clásica",
    viewClassic: "Ver versión clásica",
    readMore: "Leer más",
    featuredTag: "Editorial",
    aboutCard: "Sobre Saumama",
    figuresCard: "Saumama en cifras",
    standardsCard: "Estándares",
    sections: {
      purpose: "Propósito",
      what: "Qué hacemos",
      project: "Proyecto",
...
const en: Dictionary = {
  ...
  blogPage: {
    ...
    versionNote: "Alternative blog-style version — compare it with the classic version",
    viewClassic: "View classic version",
    readMore: "Read more",
    featuredTag: "Editorial",
    aboutCard: "About Saumama",
    figuresCard: "Saumama in numbers",
    standardsCard: "Standards",
    sections: {
      purpose: "Purpose",
      what: "What we do",
      project: "Project",
