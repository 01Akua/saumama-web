...
const es = {
  ...
  aboutPage: {
    ...
    team: [
      { name: "Abraham Korman", role: "Cofundador — Director de Estrategia Climática y SBN", bio: "Décadas en la intersección entre política energética, mercados financieros y conservación del territorio." },
      ...
      { name: "Andrés Etter", role: "Ecología del Paisaje · SIG y Big Data", bio: "Más de 30 años y 80 publicaciones mapeando ecosistemas críticos en la Amazonía y los Llanos Orientales." },
      { name: "Armando Sarmiento", role: "Economía Territorial · Geoinformática", bio: "Análisis económico territorial y modelamiento espacial del paisaje." },
      { name: "Sandra Montenegro", role: "Experta Legal — Tenencia de la Tierra", bio: "Seguridad jurídica de la tierra para las comunidades." },
      { name: "Laura Tibavizco", role: "Ecología · Restauración · Finanzas para la Biodiversidad", bio: "Estándares de créditos de biodiversidad y criterios sociales para su implementación." },
    ],
...
const en: Dictionary = {
  ...
  aboutPage: {
    ...
    team: [
      { name: "Abraham Korman", role: "Co-founder — Climate Strategy & NBS Director", bio: "Decades at the intersection of energy policy, financial markets and territorial conservation." },
      ...
      { name: "Andrés Etter", role: "Landscape Ecology · GIS & Big Data", bio: "30+ years and 80+ publications mapping critical ecosystems across the Amazon and the Eastern Plains." },
      { name: "Armando Sarmiento", role: "Territorial Economics · Geoinformatics", bio: "Territorial economic analysis and spatial landscape modeling." },
      { name: "Sandra Montenegro", role: "Legal Expert — Land Tenure", bio: "Legal certainty of land for communities." },
      { name: "Laura Tibavizco", role: "Ecology · Restoration · Biodiversity Finance", bio: "Biodiversity credit standards and social criteria for their implementation." },
    ],
